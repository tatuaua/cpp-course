...
class PNG
{
    public:
         ...
         */
        PNG(std::string const & file_name);
         ...
         */
       const RGBAPixel & operator()(size_t x, size_t y) const;
         ...
         */
        bool readFromFile(std::string const & file_name);
    ...
    private:
        ...
        bool _read_file(std::string const & file_name);
        void _clear();
        ...
        size_t _index(size_t x, size_t y) const;
};
